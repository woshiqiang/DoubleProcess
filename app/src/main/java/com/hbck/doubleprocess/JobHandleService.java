...
//		scheduleJob(getJobInfo());
		boolean isLocalServiceWork = isServiceWork(this, "com.hbck.doubleprocess.LocalService");
		boolean isRemoteServiceWork = isServiceWork(this, "com.hbck.doubleprocess.RemoteService");
